...
export default function Home() {
    return (
        <section className='container'>
            ...
            <div className='grid h-56 place-items-center gap-5 lg:grid-cols-4'>
                {HOME_CARD.map(({ id, icon, title, description }) => (
                    <Card key={id} className='h-full transition duration-300 hover:scale-105'>
                        <Link href='#'>
